package br.com.stratus.cx.utils;

import static br.com.stratus.cx.commons.InvokedMethodListener.reportLog;
import static br.com.stratus.cx.commons.Properties.MSG_EXCLUIRSEMSUCESSO;
import static br.com.stratus.cx.commons.Properties.MSG_EXCLUIRSUCESSO;
import static br.com.stratus.cx.commons.Properties.MSG_SEMSELECIONAR;
import static br.com.stratus.cx.commons.Properties.getCurrentPlatform;
...
public class GeneralButtonsPage {
	...
	private static final String LABEL_INCONFORMIDADE = "Alguns dos valores informados já existe no sistema.";
	...
	@FindBy(name = "filtro.assunto")
	private WebElement filtroAssunto;
	...
	@FindBy(xpath = "//tr/td[@data-field='Nome']")
	private List<WebElement> tabela;
	
	public void validarTabelaGeral(String value) {
		dsl.validarTabela(tabela, value);
	}
	...
	public void setAssuntoFiltro(String value) {
		dsl.explicityWaitClickable(filtroAssunto);
		dsl.preencherCampo(filtroAssunto, value);
		dsl.reportLogs("Preencheu o campo Nome no filtro", INFO);
	}
	public boolean validarValoresExistentes() {
		return returnValueBalao()
				.equals(LABEL_INCONFORMIDADE);
	}
	...
	public void searchSelect(String value) {
		dsl.explicityWaitVisible(search);
	...
	public String returnValueBalao() {
		try {
			dsl.explicityWaitVisible(balaoInformacao);
		} catch (TimeoutException e) {
			dsl.reportLogs(e.getMessage(), WARNING);
		...
		waitElement(500);
		return dsl.returnMensagem(balaoInformacao);
	}
	/**
	...
	public void excluirComSucessoPreAtendimento(String value) {
		clickButtonFiltro();
		setAssuntoFiltro(value);
		clickButtonPesquisar();
		try {
			checkBoxListagem();
		} catch (IndexOutOfBoundsException e) {
